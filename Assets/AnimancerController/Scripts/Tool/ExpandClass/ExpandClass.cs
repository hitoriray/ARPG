...
public static class ExpandClass
{
    ...
    public static void Add(this AnimancerEvent.Sequence events, List<AnimancerEvent> animancerEventList,
    ...
    /// <param name="animancerEventList"></param>
    /// <param name="animancerEvent"></param>
    public static void Remove(this AnimancerEvent.Sequence events, List<AnimancerEvent> animancerEventList,
        AnimancerEvent animancerEvent)
    {
